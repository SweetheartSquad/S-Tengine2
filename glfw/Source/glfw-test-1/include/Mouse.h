...
public:
	...
	// Clears the lists of justPressed and justReleased buttons
	void update();

	// Inserts _glfwMouseCode into the lists of justPressed and pressed buttons
	void mouseDownListener(int _glfwMouseCode);
	// Inserts _glfwMouseCode into the list of justPressed buttons and removes it from the lists of justPressed and pressed buttons
...
private:
	...
	// List of mouse buttons which are currently pressed down
	std::map<int, int> pressedButtons;
	// List of mouse buttons which were pressed down since the mouse's last call to update
	std::map<int, int> justPressedButtons;
	// List of mouse buttons which were released since the mouse's last call to update
