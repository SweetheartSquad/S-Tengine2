	...
	Scene()
{
	...
	cube3->mesh->pushTextrue2D(Resource::loadImage("../assets/img_cheryl.jpg", 256, 256, SOIL_LOAD_AUTO), 256, 256);
	...
	cube4->mesh->pushTextrue2D(Resource::loadImage("../assets/img_cheryl.jpg", 256, 256, SOIL_LOAD_RGB), 256, 256);
