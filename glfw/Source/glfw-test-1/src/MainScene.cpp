...
MainScene::MainScene():Scene()
{
	...
	//cube3->vertexBuffer->configureVertexAttributes(cube3->shader->get_aPositionVertex(), 0);
	//cube3->vertexBuffer->configureVertexAttributes(cube3->shader->get_aFragColor(), sizeof(float)*3);
