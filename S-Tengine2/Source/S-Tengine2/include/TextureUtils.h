...
public:
	...
	static std::vector<glm::vec2> getCurves(Texture *_tex, unsigned long int _threshold = 128, unsigned long int _smooth = 0);

	static bool isEdge(Texture * _texture, unsigned long int _x, unsigned long int _y, unsigned long int _threshold = 128);
