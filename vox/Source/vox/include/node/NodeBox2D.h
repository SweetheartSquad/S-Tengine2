...
class NodeBox2D : public virtual NodeUpdatable, public virtual NodeTransformable {
public:
	b2Body * body;
	b2BodyDef bodyDef;
	...
	explicit NodeBox2D(b2BodyType _bodyType = b2_dynamicBody, bool _defaultFixture = true, Transform * _transform = new Transform());
	~NodeBox2D();	
